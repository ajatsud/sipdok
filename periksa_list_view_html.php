...
<div class="container">
	<h1>Periksa</h1>
	<form action="/periksa/search" method="post" autocomplete="off">
		<div class="row">
			<div class="three columns">
				<label>Keyword</label>
				<input class="u-full-width" type="text" name="periksa[keyword]" placeholder="Nama atau alamat" value="<?php echo isset($keyword) ? $keyword : ''; ?>">
			</div>
			<div class="three columns">
				<label>Jenkel</label>
				<select class="u-full-width" name="periksa[jenkel]">
			...
			<div class="three columns">
				<label>Periode</label>
				<select name="periksa[period]" class="u-full-width">
	...
	<p><a class="button" href="/periksa/add">Tambah</a></p>
		...
		<table class="u-full-width">
			...
			<tbody>
				...
				<tr>
					...
					-->
					<td><?php echo $record['anamnesa']; ?></td>
					<td><?php echo $record['pemeriksaan']; ?></td>
					<td><?php echo $record['diagnosa']; ?></td>
					<td><?php echo $record['terapi']; ?></td>
					<td><?php echo $record['biaya']; ?></td>
					<td>
						<form action="/periksa/edit" method="post">
							<input type="hidden" name="periksa[id]" value="<?php echo $record['id']; ?>">
							<input type="submit" value="Edit" class="button-warning">
						</form>
					</td>
					<td>
						<form action="/periksa/delete" method="post" onsubmit="return confirm('Apakah anda yakin akan menghapus ?');">
							<input type="hidden" name="periksa[id]" value="<?php echo $record['id']; ?>">
