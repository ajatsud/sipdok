...
<head>
    ...
    <!--[if lt IE 9]>
      <script src="../res/vendor/bootstrap/js/html5shiv.min.js"></script>
      <script src="../res/vendor/bootstrap/js/respond.min.js"></script>
    <![endif]-->
</head>
<body>
	<!-- wrapper -->
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Sipdok v0.1</a>
            </div>
			<!-- brand -->
