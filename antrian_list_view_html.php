...
<div class="container">
	<h1>Antrian</h1>
	<form action="/antrian/search" method="post" autocomplete="off">
		<div class="row">
			<div class="three columns">
				<label>Keyword</label>
				<input class="u-full-width" type="text" name="antrian[keyword]" placeholder="Nama atau alamat" value="<?php echo isset($keyword) ? $keyword : ''; ?>">
			</div>
			<div class="three columns">
				<label>Jenkel</label>
				<select class="u-full-width" name="antrian[jenkel]">
					<option value="%" <?php echo isset($jenkel) && $jenkel == '%' ? 'selected' : ''; ?>>Semua</option>
			...
			<div class="three columns">
				<label>Periode</label>
				<select name="antrian[period]" class="u-full-width">
